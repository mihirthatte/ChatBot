...
import util  # General utils including config params and database connection
...
response = util.queryYesNo("Continue?")
...
## Tab Config and Make Connection to Database ##
    ...
    connection = util.dbConnection(DBHOST, DBUSER, DBPASSWORD, DBNAME, DBCHARSET)
